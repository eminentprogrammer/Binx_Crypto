...
PAYSTACK_FAILED_URL = getattr(settings, 'PAYSTACK_FAILED_URL', 'apps.paystack:failed_page')

PAYSTACK_SUCCESS_URL = getattr(settings, 'PAYSTACK_SUCCESS_URL', 'apps.paystack:success_page')

PAYSTACK_API_URL = 'https://api.paystack.co'

PAYSTACK_LIB_MODULE = getattr(settings, 'PAYSTACK_LIB_MODULE', 'apps.paystack.utils')
